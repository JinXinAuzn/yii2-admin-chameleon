...
namespace jx\admin_chameleon\models\searchs;

use yii\base\Model;
use yii\data\ActiveDataProvider;
use jx\admin_chameleon\models\Master as MasterModel;

/**
 * Master represents the model behind the search form about `jx\admin_chameleon\models\Master`.
 */
