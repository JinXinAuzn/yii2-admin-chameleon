...
namespace jx\admin_chameleon\components;
 ...
 *
 * ```
 * Yii::$container->set('jx\admin_chameleon\components\Configs',[
 *     'db' => 'customDb',
 *     'menuTable' => 'admin_menu',
 * ]);
 * ```
...
{
    const CACHE_TAG = 'jx.admin_chameleon';
    ...
    public static function instance()
    {
        if (self::$_instance === null) {
            $type = ArrayHelper::getValue(Yii::$app->params, 'jx.admin_chameleon.configs', []);
