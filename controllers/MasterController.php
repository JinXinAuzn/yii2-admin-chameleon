...
use jx\admin_chameleon\components\AdminLog;
use Yii;
use jx\admin_chameleon\models\form\Login;
use jx\admin_chameleon\models\form\Signup;
use jx\admin_chameleon\models\form\ChangePassword;
use jx\admin_chameleon\models\Master;
use jx\admin_chameleon\models\searchs\Master as MasterSearch;
	...
	public function beforeAction($action)
	{
		if (parent::beforeAction($action)) {
			if (Yii::$app->has('mailer') && ($mailer = Yii::$app->getMailer()) instanceof BaseMailer) {
				...
				$mailer->setViewPath('@jx/admin_chameleon/mail');
			}
			return true;
		}
		return false;
